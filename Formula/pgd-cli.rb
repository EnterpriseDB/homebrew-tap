...
class PgdCli < Formula
  ...
  on_macos do
    ...
    if Hardware::CPU.arm?
      url "https://downloads.enterprisedb.com/public/homebrew-edb/raw/versions/6.2.0-1/pgd-cli_6.2.0_darwin_arm64.tar.gz", using: CurlDownloadStrategy
    ...
    if Hardware::CPU.intel?
      url "https://downloads.enterprisedb.com/public/homebrew-edb/raw/versions/6.2.0-1/pgd-cli_6.2.0_darwin_amd64.tar.gz", using: CurlDownloadStrategy
